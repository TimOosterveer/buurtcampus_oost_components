<script>
 export let data;   
			...
			<!-- <a href={data.stekjes.slug}>
				<article class={data.stekjes.categories[0].naam}>
					<img src={data.stekjes.fotos[0].url} alt="foto van {data.stekjes.naam}" />
					<div>
						<h3>{data.stekjes.naam}</h3>
